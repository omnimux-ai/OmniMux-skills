...
- Duration: 15 seconds for story/advertising/case demos; 10 seconds for simple product/UI/action demos.
- Aspect ratio: 16:9 for cinematic/brand/UI/game demos; 9:16 for short drama/social ads; 1:1 only for feed/poster-like requests.
- Style: realistic cinematic for real-world scenes unless anime/MG/illustration is requested.
- Sound: realistic ambience and restrained sound design; no random BGM unless useful.
- Ending: include a final beat, product/logo/title card, emotional reaction, or transformation payoff.
