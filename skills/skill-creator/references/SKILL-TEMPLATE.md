...
name: <skill-name>
description: |
  <一句话中文摘要，说明这个 skill 做什么>。<展开说明工作流：输入 -> 关键转换 -> 输出>。
  当用户想要<中文触发说法1>、<中文触发说法2>或<中文触发说法3>时使用。
---
...
desc-en: "<one paragraph, roughly 95–260 words; hard cap 280>"
desc-cn: "<一个自然段，150–400 个汉字；定位 / 输入 / 3–6 步 / 产出 / 能力边界>"
